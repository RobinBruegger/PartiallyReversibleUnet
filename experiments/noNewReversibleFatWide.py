...
EXPERIMENT_NAME = "Reversible NO_NEW120 {}encoder, 1decoder".format(encDepth)
EPOCHS = 1000
BATCH_SIZE = 1
VIRTUAL_BATCHSIZE = 1
...
#lr_sheudler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode="max", factor=0.2, patience=60, verbose=True)
